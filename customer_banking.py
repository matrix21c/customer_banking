...
def main():
    ...
    savings_maturity = int(input("Enter the number of months the savings account will be held: "))
    ...
    cd_maturity = int(input("Enter the number of months the CD account will be held: "))
